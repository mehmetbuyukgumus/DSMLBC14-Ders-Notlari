...
# 1: Hipotezi kur
# H0: M1 = M2 yani sigara içenlerin ödediği hesabın orlamasıyla içmeyenler arasında bir fark yoktur.
# H1 M1 != M2 yani sigara içenlerin ödediği hesabın orlamasıyla içmeyenler arasında bir fark vardır.
...
# H1 Normal dağılım varsayımı sağlamamaktadır.
