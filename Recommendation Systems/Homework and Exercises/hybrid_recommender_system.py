...
## Efsun'un çözümü
movies_watched = list(random_user_df.columns[~random_user_df.isna().any()])
...
users_same_movie = list(user_movie_count[user_movie_count["movie_count"] > perc]["userId"])
...
# Adım 3: random_user göre diğer ıdlerle korelasyonu 0.65'ten yüksekleri top_users olarak kaydet
